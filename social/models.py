...
class User(AbstractUser):
    ...
    #در این قسمت  ما این فیلد را متصل کردیم به سلف   و منظور از سلف یعنی همان خودش 
    #خودش هم برابر است  با کلاس مادر او که برابر است با یوزر 
    following=models.ManyToManyField("self",through="Contact",related_name="followers",symmetrical=False)
    # مفهوم سیمتریکال: یعنی اینجا که برابر قرارش دادیم با فالس چون فیلد ما اینجا فالوینگ است و جنگو به صورت دیفالت میگوید که وقتی یوزر اول یوزر دوم را فالو کرده است پس من هم کاری میکنم که یوزر دوم هم یوزر اول را فالو کند به صورت اتوماتیک وار بخاطر همین ما مقدار ان را فالس میکینیم که دیگر به این مشکل بر نخوریم اما اگر این اتریبیوت را قرار ندهیم دیفالت جنگو به صورت ترو است
...
class Contact(models.Model):
    #یوزر فرام مربوط میشود به کسی که فالو میکند 
    user_from=models.ForeignKey(User,related_name="rel_from_set", on_delete=models.CASCADE)
    #یوزر تو به معنی کسی که فالو میشود 
